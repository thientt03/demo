...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th5 30, 2019 lúc 01:11 PM
...
--
-- Các ràng buộc cho bảng `reason`
--
ALTER TABLE `reason`
  ADD CONSTRAINT `reason_ibfk_1` FOREIGN KEY (`id`) REFERENCES `nhanvien` (`id`);
COMMIT;
